    ...
    <header>
      <menu class="navbar" type="toolbar" style="border-radius: 0px 0px 10px 10px;">
          ...
          <a class="nav-item ts20<?=$page==3 ? "active": ""?>" href="/about.php">О нас</a>
              <form class="form i-block" style="float: right; width: 350px" action="search.php" method="post">
                <input class="form-input i-block" style="width: 60%;" type="text" name="text" value="" placeholder="Например, Борщ">
